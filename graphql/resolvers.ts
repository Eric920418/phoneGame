...
const mockPosts = [
  {
    ...
    content: '<p>歡迎來到破浪三國官方論壇！</p><p>在這裡你可以：</p><ul><li>討論遊戲內容</li><li>分享遊戲攻略</li><li>回報遊戲問題</li><li>結交志同道合的玩家</li></ul>',
    excerpt: '歡迎使用破浪三國官方論壇！',
    author: 'Admin',
...
const mockAnnouncements = [
  {
    ...
    title: '遊戲即將開放測試！',
    slug: 'game-beta-test',
    content: '<p>親愛的玩家們：</p><p>我們很高興地宣布，破浪三國即將開放封閉測試！敬請期待更多消息。</p>',
    excerpt: '破浪三國即將開放封閉測試！',
    type: 'general',
    isPinned: true,
    isPublished: true,
